...
public class CartPresenterImpl implements CartPresenter {
    ...
    public void onCreateView(Bundle savedInstanceState) {
        if (savedInstanceState == null) {
            ...
            cartRoot.showShopList(ShopDataSource.getShopCartList(1));
        } else {
            cart = CartDataSource.getCart(savedInstanceState.getInt("CartType"));
            cartRoot.showShopList(ShopDataSource.getShopCartList(savedInstanceState.getInt("CartType")));
        }
    }
    ...
    public void refreshShopList(int tag) {
        ...
        cartRoot.showShopList(ShopDataSource.getShopCartList(tag));
    }
